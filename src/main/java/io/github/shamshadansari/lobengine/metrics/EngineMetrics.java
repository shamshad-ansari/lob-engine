...
public class EngineMetrics {
    ...
    private final AtomicLong fillsGenerated  = new AtomicLong(0);
    private final AtomicLong cancellations   = new AtomicLong(0);
    private final AtomicLong cancelMisses    = new AtomicLong(0);
